  ...
  return (
    <SearchLayout>
      <Grid>
            ...
            <Grid item xs={8}>
              <Breadcrumbs aria-label="breadcrumb">
                <Link
                  ...
                  href="home/"
                >
                  <HomeIcon sx={{ mr: 0.5, ml: 2 }} fontSize="inherit" />
                </Link>
                <Link
                  underline="hover"
                  sx={{ display: "flex", alignItems: "center" }}
        ...
        {/* DataGrid Table */}
        <Grid item xs={12} sx={{ height: 400, mt: 2 }}>
          <DataGrid
            rows={data}
            columns={columns}
            initialState={{
...
>
  ...
  >
    ...
    <Box id="modal-description">
      ...
      /> */}
      <FormGroup>
        <FormControlLabel control={<Checkbox />} label="Match case" />
        <FormControlLabel
    ...
    <Button variant="contained" color="primary"  startIcon={<InsertDriveIcon />} size="small" 
     sx={{
      mt: 2,
      backgroundColor: '#E9EEF6',
      color: '#393940',
